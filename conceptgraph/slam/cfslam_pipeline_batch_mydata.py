...
def main(cfg : DictConfig):
    ...
    color_files = sorted([f for f in os.listdir('/scratch3/kat049/concept-graphs/my_local_data/KITTI/2011_09_26/2011_09_26_drive_0019_sync/image_02/data') if f.lower().endswith(('.png', '.jpg', '.jpeg'))])
    color_files = color_files[5:-5]
    depth_files = sorted([f for f in os.listdir('/scratch3/kat049/concept-graphs/my_local_data/KITTI/2011_09_26/2011_09_26_drive_0019_sync/depth/image_02') if f.lower().endswith(('.png', '.jpg', '.jpeg'))])
    ...
    if cfg.save_objects_all_frames:
        save_all_folder = f"/scratch3/kat049/concept-graphs/my_local_data/KITTI/2011_09_26/2011_09_26_drive_0019_sync/image_02/data/objects_all_frames/{cfg.gsa_variant}_{cfg.save_suffix}"
        os.makedirs(save_all_folder, exist_ok=True)

    for idx in trange(len(color_files)):
        # get color image
        color_path = color_files[idx]
        image_original_pil = Image.open(color_path)

        
        # color_path = color_files[idx]
        depth_path = depth_array[idx]
